"""UI resource serving for the GeoMap MCP App.

This module provides the HTML bundle that hosts render in an iframe when
the geo_map tool is called. The HTML is a single-file bundle built
...
def get_ui_html() -> str:
    """Get the geo map UI HTML bundle.

    Returns:
        The complete HTML string ready to be served as an MCP resource

    Raises:
        FileNotFoundError: If mcp-app.html hasn't been built yet
    """
