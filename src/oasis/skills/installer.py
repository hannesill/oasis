"""Install OASIS skills to AI coding tool directories."""

import shutil
from dataclasses import dataclass
from pathlib import Path

from oasis.config import logger
...
def install_skills(
    ...
    - .claude/skills/oasis-api/SKILL.md
    - .cursor/skills/oasis-api/SKILL.md
...
def get_installed_skills(
    ...
    """List installed OASIS skills for a specific AI tool.
...
def get_all_installed_skills(
    ...
    """List installed OASIS skills across all AI tools.
