...
This directory contains skills for the OASIS framework, covering clinical research concepts and system functionality.
...
| Skill | Description |
|-------|-------------|
| [oasis-api](system/oasis-api/SKILL.md) | Python API for OASIS clinical data queries |
| [oasis-research](system/oasis-research/SKILL.md) | Structured clinical research workflow and protocol drafting |
| [create-oasis-skill](system/create-oasis-skill/SKILL.md) | Guide for creating new OASIS skills |
...
2. **Pre-computed Tables**: Most clinical skills reference pre-computed derived tables in `mimiciv_derived` schema. These are available on BigQuery and can be regenerated locally via `oasis init-derived`.
