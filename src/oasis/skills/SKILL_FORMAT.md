...
This document defines how OASIS skills should be structured, including metadata, provenance tracking, the tier system for trust levels, and the category system for skill types.
...
Skills are organized by category under `src/oasis/skills/`:
...
│   │   └── ...
│   └── ...
├── system/             # OASIS framework and data structure knowledge
│   ├── oasis-api/
│   │   └── SKILL.md
│   └── ...
├── installer.py
